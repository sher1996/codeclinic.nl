      ...
      <AnimatePresence>
        {showPasswordModal && (
          ...
          >
            ...
            >
              <h3 id="admin-modal-title" className="text-xl font-bold text-white mb-4">Admin Access</h3>
              
              <div id="admin-modal-description" className="sr-only">Admin login form for accessing administrative functions</div>
